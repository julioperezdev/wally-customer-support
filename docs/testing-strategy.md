...
| `TC-012G` | P1 | Entrega de imagen de catálogo | Una coincidencia única genera `IMAGE`, el adapter usa URL temporal y los listados/seguimientos no adjuntan media | JUnit + contract |
