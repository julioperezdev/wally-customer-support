...
public class JpaAgentActivationCommandGuardAdapter implements AgentActivationCommandGuard {

    private static final HexFormat HEX_FORMAT = HexFormat.of();

    private final SpringDataAgentActivationCommandClaimRepository repository;
